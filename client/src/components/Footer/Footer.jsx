      ...
      <footer className="text-center text-lg-start text-white">
        <section className="d-flex justify-content-between px-4">
          ...
          <div className="socials">
            {/* <a
              href="https://twitter.com/_Somansh_0512"
          ...
          <div className="px-md-5 text-center text-md-start mt-5">
            <div className="row mt-3">
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <div className="mt-4">
                  Shop now with your{" "}
                  <span className="text-uppercase opacity-75">shop buddy.</span>{" "}
              ...
              <div className="col-md-2 col-lg-4 col-xl-2 mx-auto mb-4 mt-3">
                ...
                <p className="p_links">
                  <Link to="/products" className="text-white ms-3">
                    Clothes
                  </Link>
                </p>
                <p className="p_links">
              ...
              <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4 mt-3">
                ...
                <p className="p_links">
                  <Link to="/aboutus" className="text-white mx-3">
                    About Us
                  </Link>
                </p>
                <p className="p_links">
                  <Link to="/policy/privacy" className="text-white mx-3">
                    Privacy Policy
                  </Link>
                </p>
                <p className="p_links">
                  <Link to="/policy/return" className="text-white mx-3">
                    Return Policy
                  </Link>
                </p>
              </div>
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 mt-3">
                ...
                <hr className="mb-4 mt-0 d-inline-block mx-auto" />
                <p>
                  <i className="fas fa-home mx-3"></i>Karnal, Haryana, IN
                </p>
                <p>
                  <i className="fas fa-envelope mx-3"></i>Somansh2002@gmail.com
                </p>
                <p>
                  <i className="fas fa-phone mx-3"></i>+ 91 9034 95 2636
                </p>
              </div>
            </div>
          </div>
