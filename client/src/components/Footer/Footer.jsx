            ...
            >
                <section className="d-flex justify-content-between px-4">
                    ...
                    <div className='socials'>
                        <a href="https://twitter.com/_Somansh_0512" className="text-white me-4" target="_blank" rel='noreferrer noopener'>
                            <i className="fab fa-twitter"></i>
                        </a>
                        <a href="https://www.instagram.com/_Somansh_0512" className="text-white me-4" target="_blank" rel='noreferrer noopener'>
                            <i className="fab fa-instagram"></i>
                        </a>
                        <a href="https://www.linkedin.com/in/Somansh--315593201" className="text-white me-4" target="_blank" rel='noreferrer noopener'>
                            <i className="fab fa-linkedin"></i>
                        </a>
                        <a href="https://github.com/Somansh--0512" className="text-white me-4" target="_blank" rel='noreferrer noopener'>
                    ...
                    <div className="px-md-5 text-center text-md-start mt-5">
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 mt-3">
                                ...
                                <p><i className="fas fa-envelope mx-3"></i>Somansh.karnal@gmail.com</p>
