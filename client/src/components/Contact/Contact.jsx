        ...
        <div className='bg-grey'>
            <div className="contact-conainer">
                ...
                <div className="d-flex mb-3 pt-5 justify-content-between contact-links">
                    ...
                    <a href="mailto:Somansh.karnal@gmail.com" className='sendmail'> <EmailIcon className='mx-2 icon' /> Somansh.karnal@gmail.com</a>
                </div>
                <div className="d-flex my-3 justify-content-between contact-links">
                    <span className='contact-name text-center'>Instagram </span>
                    <a href="https://www.instagram.com/_Somansh_0512" rel="noreferrer" target="_blank" className='insta'> <InstagramIcon className='mx-2 icon' /> _Somansh_0512</a>
                </div>
                <div className="d-flex my-3 justify-content-between contact-links">
                    <span className='contact-name text-center'>LinkedIn </span>
                    <a href="https://www.linkedin.com/in/Somansh--315593201/" rel="noreferrer" target="_blank" className='linkedin'> <LinkedInIcon className='mx-2 icon' /> Somansh </a>
                </div>
            </div>
        </div>
    )
